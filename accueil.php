...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
   ...
   <ul class="navbar-nav">
      ...
      <!--<li class="nav-item d-none d-sm-inline-block">
        <h1><g><a href="#" class="nav-link">SUIVI STOCK</a></g></h1>
      </li>-->
      <li class="nav-item d-none d-sm-inline-block">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="Public/template/dist/img/panier.png" alt="User Avatar" class="img-size-50 mr-3 img-circle">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">SUIVI STOCK</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="#" class="nav-link active">
              ...
              <li class="nav-item">
                <a href="src/view/produit/addProduit.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Ajouter un produit</p>
                </a>
              </li>
             <li class="nav-item">
                <a href="src/view/produit/listeProduit.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item">
            ...
            <a href="#" class="nav-link active">
              ...
              <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="src/view/user/addUser.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Ajouter un utilisateur</p>
                </a>
              </li>
             <li class="nav-item">
                <a href="src/view/user/addUser.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="#" class="small-box-footer">Liste des produits <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
