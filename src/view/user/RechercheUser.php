      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header ">
            <h2 class="card-title md-7 ofset-7 ">RECHERHER UN UTILISATEUR</h2>
            </div>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group">
                  <label>Nom</label>
                  <input type="text" name="nom" style="width: 100%;" class="form-control" readonly>
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              <div class="col-md-6">
                <div class="form-group">
                  <label>Prenom</label>
                  <input type="text" name="prenom" style="width: 100%;" class="form-control" readonly>
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  <label>Email</label>
                  <input type="email" name="email" style="width: 100%;" class="form-control" readonly>
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
            ...
            <div class="row">
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  <label>Etat</label>
                  <input type="text" name="etat" style="width: 100%;" class="form-control" readonly>
                </div>
                <!-- /.form-group -->
